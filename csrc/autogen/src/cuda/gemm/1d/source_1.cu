...
void na1d_nn_cuda_gemm_half_64x64x32_32x32x32_16x8x16_3_align2(
  void * attn_ptr,
  void * value_ptr,
  void * output_ptr,
  int batch_size,
...
void na1d_nn_cuda_gemm_bfloat16_64x64x32_32x32x32_16x8x16_3_align8(
  void * attn_ptr,
  void * value_ptr,
  void * output_ptr,
  int batch_size,
...
void na1d_nn_cuda_gemm_bfloat16_64x64x32_32x32x32_16x8x16_3_align4(
  void * attn_ptr,
  void * value_ptr,
  void * output_ptr,
  int batch_size,
...
void na1d_nn_cuda_gemm_bfloat16_64x64x32_32x32x32_16x8x16_3_align2(
  void * attn_ptr,
  void * value_ptr,
  void * output_ptr,
  int batch_size,
...
void na1d_in_cuda_gemm_double_64x32x16_32x16x16_8x8x4_3_align1(
  void * attn_ptr,
  void * d_output_ptr,
  void * d_value_ptr,
  int batch_size,
  ...
  using Kernel = InverseNeighborhood1D<GConfig, AConfig, DConfig>;
  Kernel kernel;
  kernel(
attn_ptr, d_output_ptr, d_value_ptr, batch_size, heads, length, dim, kernel_size, dilation, scale);
}

void na1d_in_cuda_gemm_float_64x32x16_32x16x16_16x8x8_3_align4(
  void * attn_ptr,
  void * d_output_ptr,
  void * d_value_ptr,
  int batch_size,
...
void na1d_in_cuda_gemm_float_64x32x16_32x16x16_16x8x8_3_align2(
  void * attn_ptr,
  void * d_output_ptr,
  void * d_value_ptr,
  int batch_size,
...
void na1d_in_cuda_gemm_float_64x32x16_32x16x16_16x8x8_3_align1(
  void * attn_ptr,
  void * d_output_ptr,
  void * d_value_ptr,
  int batch_size,
...
void na1d_in_cuda_gemm_half_64x64x32_32x32x32_16x8x16_3_align8(
  void * attn_ptr,
  void * d_output_ptr,
  void * d_value_ptr,
  int batch_size,
...
void na1d_in_cuda_gemm_half_64x64x32_32x32x32_16x8x16_3_align4(
  void * attn_ptr,
  void * d_output_ptr,
  void * d_value_ptr,
  int batch_size,
...
void na1d_in_cuda_gemm_half_64x64x32_32x32x32_16x8x16_3_align2(
  void * attn_ptr,
  void * d_output_ptr,
  void * d_value_ptr,
  int batch_size,
...
void na1d_in_cuda_gemm_bfloat16_64x64x32_32x32x32_16x8x16_3_align8(
  void * attn_ptr,
  void * d_output_ptr,
  void * d_value_ptr,
  int batch_size,
...
void na1d_in_cuda_gemm_bfloat16_64x64x32_32x32x32_16x8x16_3_align4(
  void * attn_ptr,
  void * d_output_ptr,
  void * d_value_ptr,
  int batch_size,
...
void na1d_in_cuda_gemm_bfloat16_64x64x32_32x32x32_16x8x16_3_align2(
  void * attn_ptr,
  void * d_output_ptr,
  void * d_value_ptr,
  int batch_size,
