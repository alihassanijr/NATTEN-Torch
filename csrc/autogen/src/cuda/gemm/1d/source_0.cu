...
void na1d_pn_cuda_gemm_double_128x128x16_64x64x16_8x8x4_3_align1(
  void * query_ptr,
  void * key_ptr,
  void * attn_ptr,
  void * bias_ptr,
  ...
  using Kernel = PointwiseNeighborhood1D<GConfig, AConfig, DConfig>;
  Kernel kernel;
  kernel(
query_ptr, key_ptr, attn_ptr, bias_ptr, batch_size, heads, length, dim, kernel_size, dilation, scale);
}

void na1d_pn_cuda_gemm_float_128x128x16_64x64x16_16x8x8_3_align4(
  void * query_ptr,
  void * key_ptr,
  void * attn_ptr,
  void * bias_ptr,
...
void na1d_pn_cuda_gemm_float_128x128x16_64x64x16_16x8x8_3_align2(
  void * query_ptr,
  void * key_ptr,
  void * attn_ptr,
  void * bias_ptr,
...
void na1d_pn_cuda_gemm_float_128x128x16_64x64x16_16x8x8_3_align1(
  void * query_ptr,
  void * key_ptr,
  void * attn_ptr,
  void * bias_ptr,
...
void na1d_pn_cuda_gemm_half_128x128x32_64x64x32_16x8x16_3_align8(
  void * query_ptr,
  void * key_ptr,
  void * attn_ptr,
  void * bias_ptr,
...
void na1d_pn_cuda_gemm_half_128x128x32_64x64x32_16x8x16_3_align4(
  void * query_ptr,
  void * key_ptr,
  void * attn_ptr,
  void * bias_ptr,
...
void na1d_pn_cuda_gemm_half_128x128x32_64x64x32_16x8x16_3_align2(
  void * query_ptr,
  void * key_ptr,
  void * attn_ptr,
  void * bias_ptr,
...
void na1d_pn_cuda_gemm_bfloat16_128x128x32_64x64x32_16x8x16_3_align8(
  void * query_ptr,
  void * key_ptr,
  void * attn_ptr,
  void * bias_ptr,
...
void na1d_pn_cuda_gemm_bfloat16_128x128x32_64x64x32_16x8x16_3_align4(
  void * query_ptr,
  void * key_ptr,
  void * attn_ptr,
  void * bias_ptr,
...
void na1d_pn_cuda_gemm_bfloat16_128x128x32_64x64x32_16x8x16_3_align2(
  void * query_ptr,
  void * key_ptr,
  void * attn_ptr,
  void * bias_ptr,
...
void na1d_nn_cuda_gemm_double_64x32x16_32x16x16_8x8x4_3_align1(
  void * attn_ptr,
  void * value_ptr,
  void * output_ptr,
  int batch_size,
  ...
  using AConfig = natten::gemm::detail::AlignmentConfig<1, 1, 1>;
  using DConfig = natten::gemm::detail::DTypeConfig<natten::float64>;
  using Kernel = NeighborhoodNeighborhood1D<GConfig, AConfig, DConfig>;
  Kernel kernel;
  kernel(
attn_ptr, value_ptr, output_ptr, batch_size, heads, length, dim, kernel_size, dilation, scale);
}

void na1d_nn_cuda_gemm_float_64x32x16_32x16x16_16x8x8_3_align4(
  void * attn_ptr,
  void * value_ptr,
  void * output_ptr,
  int batch_size,
...
void na1d_nn_cuda_gemm_float_64x32x16_32x16x16_16x8x8_3_align2(
  void * attn_ptr,
  void * value_ptr,
  void * output_ptr,
  int batch_size,
...
void na1d_nn_cuda_gemm_float_64x32x16_32x16x16_16x8x8_3_align1(
  void * attn_ptr,
  void * value_ptr,
  void * output_ptr,
  int batch_size,
...
void na1d_nn_cuda_gemm_half_64x64x32_32x32x32_16x8x16_3_align8(
  void * attn_ptr,
  void * value_ptr,
  void * output_ptr,
  int batch_size,
...
void na1d_nn_cuda_gemm_half_64x64x32_32x32x32_16x8x16_3_align4(
  void * attn_ptr,
  void * value_ptr,
  void * output_ptr,
  int batch_size,
