...
void {kernel_name}(
  ...
  using Kernel = natten::cuda::fna_hopper::KernelForward<
    {dtype}, Causal, QTileShape, KVTileShape, GemmShape, {kernel_type}, false>;
  using VarlenKernel = natten::cuda::fna_hopper::KernelForward<
    {dtype}, Causal, QTileShape, KVTileShape, GemmShape, {kernel_type}, true>;
