...
run "1d-32k-w2k-hopper-fna" na -i 32768 -d 128 -w 2048 --dtype bf16 --backend hopper-fna --bwd

# Strided NA w=2048 s=256
run "1d-32k-w2k-s256-hopper-fna" na -i 32768 -d 128 -w 2048 -s 256 --dtype bf16 --backend hopper-fna --bwd

# Blocked attention w=2048 s=2048
run "1d-32k-w2k-s2k-hopper-fna" na -i 32768 -d 128 -w 2048 -s 2048 --dtype bf16 --backend hopper-fna --bwd
...
# NA w=(80,80)
run "2d-flux-na-hopper-fna" na -i 256 256 -n 24 -d 128 -w 80 80 --dtype bf16 --backend hopper-fna --q-tile 16 8 --kv-tile 16 8 --bwd

# GNA w=(80,80) s=(16,16)
run "2d-flux-gna-hopper-fna" na -i 256 256 -n 24 -d 128 -w 80 80 -s 16 16 --dtype bf16 --backend hopper-fna --q-tile 16 8 --kv-tile 16 8 --bwd
...
# NA w=(18,24,24)
run "3d-hunyuan-na-hopper-fna" na -i 30 48 80 -n 24 -d 128 -w 18 24 24 --dtype bf16 --backend hopper-fna --q-tile 2 8 8 --kv-tile 2 8 8 --bwd

# GNA w=(18,24,24) s=(16,8,8)
run "3d-hunyuan-gna-hopper-fna" na -i 30 48 80 -n 24 -d 128 -w 18 24 24 -s 16 8 8 --dtype bf16 --backend hopper-fna --q-tile 2 8 8 --kv-tile 2 8 8 --bwd

# --- Dry run ---
run "dry-run" na -i 16 16 16 -d 128 --dtype bf16 --dry-run

# --- NATTEN attention (FMHA) ---
run "attn-hopper-fmha" attn -q 1024 -d 128 --dtype bf16 --backend hopper-fmha --bwd
